...
const sds = {
  ...
  saison: 4,
  image:
    "https://miro.medium.com/max/3012/1*nLjuBFZnmkQ1vIGar2f1vg.jpeg",
  rating: 3
};
const rosh = {
  ...
  saison: 1,
  image:
    "https://images-eu.ssl-images-amazon.com/images/I/61JYuIGkT1L.jpg",
  rating: 4
};
...
const naruto = {
  ...
  saison: 1,
  image: "https://media.senscritique.com/media/000018306626/source_big/Naruto_Shippuden_Kai.jpg",
  rating: 3
};
